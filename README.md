...
* **?**："Unleashing the Power of Visual Prompting At the Pixel Level",arXiv,2022(*Shanghai Jiao Tong University*)[[Paper](https://arxiv.org/abs/2212.10556)][[Code](https://github.com/ucsc-vlaa/evp)]
* **DPT**："Dual Modality Prompt Tuning for Vision-Language",arXiv,2023(*Chinese Academy of Sciences*)[[Paper](https://arxiv.org/abs/2208.08340)][[Code](https://github.com/fanrena/dpt)]
* **?**："Bayesian Prompt Learning for Image-Language Model Generalization",arXiv,2022(*University of Amsterdam*)[[Paper](https://arxiv.org/abs/2210.02390)]
* **LION**："LION: Implicit Vision Prompt Tuning",arXiv,2023(*Peking University*)[[Paper](https://arxiv.org/abs/2303.09992)]
* **AP**："Amortized Prompt: Lightweight Fine-Tuning for CLIP in Domain Generalization",arXiv,2021(*The University of Tokyo*)[[Paper](https://arxiv.org/abs/2111.12853v1)]
